  ...
  const todaysFixtures = [
    {
      ...
      status: "Live",
      venue: "Maharaja Yadavindra Singh International Cricket Stadium, Mullanpur, Chandigarh , Punjab",
      time: "1:30 PM",
      date: "Today",
    ...
    {Upcoming
      team1: "Barbados Royals Women",
      team2: "Guyana Amazon Warriors Women",
      matchType: "WCPL, 2025",
      status: "Upcoming",
